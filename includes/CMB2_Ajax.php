...
class CMB2_Ajax {
	...
	public function get_oembed( $args ) {
		...
		return '<p class="ui-state-error-text">' . sprintf( __( 'No oEmbed Results Found for %1$s. View more info at %2$s.', 'cmb2' ), $fallback, '<a href="https://codex.wordpress.org/Embeds" target="_blank">codex.wordpress.org/Embeds</a>' ) . '</p>';
